...
#define NRF_CS_GPIO SPI_CS1_GPIO_Port
#define NRF_CS_PIN SPI_CS1_Pin
...
void nRF24_PTX_init(const uint8_t* addr, uint8_t channel) {
	// Write to registers their initial values
	nRF24_write_register(nRF24_REG_CONFIG, 0x00);
...
void nRF24_SetAddr(pipe_addr_t pipe, const uint8_t* addr) {
	...
	curr_addr = nRF24_read_register(nRF24_CMD_R_REGISTER | nRF24_ADDR_REGS[pipe]);
