...
static const screens_t tgt_conf_flow_s_screens[2] = {
    [false] = SCR_O_TARGET_SELECTOR,
    [true]  = SCR_M_HOME,
};

static const screens_t tgt_conf_flow_l_screens[] = {
    SCR_O_MAIN_MENU,
};
...
screen_properties_t tgt_conf_screen = {
    ...
    .short_press_next_screens = tgt_conf_flow_s_screens,
    .long_press_next_screens  = tgt_conf_flow_l_screens,
