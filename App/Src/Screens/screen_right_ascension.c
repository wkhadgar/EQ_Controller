...
static void update_buffers(eqm_settings_t const* settings) {
    sprintf((char*) ra_buffer, "%02dh%02dm%02ds", settings->RA.hours,
            settings->RA.minutes, settings->RA.seconds);
}
 ...
 */
static const screens_t right_ascension_flow_s_screens[] = {
    SCR_M_HOME,
};
 ...
 * @brief Fluxo de destino da tela de configuração de ascensão reta.
 */
static const screens_t right_ascension_flow_l_screens[] = {
    SCR_O_MAIN_MENU,
};
...
screen_properties_t right_ascension_screen = {
    ...
    .short_press_next_screens = right_ascension_flow_s_screens,
    .long_press_next_screens  = right_ascension_flow_l_screens,
    .contents                 = ra_cnts,
    .cursor_bitmap            = NULL,
