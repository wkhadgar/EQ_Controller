...
static const screens_t mode_conf_flow_s_screens[2] = {
    [false] = SCR_O_EQM_MODE,
    [true]  = SCR_M_HOME,
};

static const screens_t mode_conf_flow_l_screens[] = {
    SCR_O_MAIN_MENU,
};
...
screen_properties_t mode_conf_screen = {
    ...
    .short_press_next_screens = mode_conf_flow_s_screens,
    .long_press_next_screens  = mode_conf_flow_l_screens,
