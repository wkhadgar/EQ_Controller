...
typedef enum __attribute__((packed)) sh1106_commands {
    SH1106_CMD_COL_LOW = 0x02,        /**< Set the address of the lower column. */
    SH1106_CMD_COL_HIGH = 0x10,       /**< Set the address of the upper column. */
    SH1106_DC_DC_VOLTAGE = 0x32,      /**< Sets DC-Dc to 8v. */
    SH1106_CMD_SET_MUX = 0xA8,        /**< Sets the multiplexer ratio. */
    SH1106_CMD_SET_OFFSET = 0xD3,     /**< Set the display offset. */
